...
public class DemoTaskTwo {
    ...
    public Map<Author, List<Book>> booksByAuthors(List<Author> authors, List<Book> books) {
        return books.stream()
    ...
    public void launch() {
        ...
        sortByAge(authors).forEach(System.out::println);
        System.out.println("\nАвторы-пенсионеры:");
        pensioners(authors).forEach(System.out::println);
        System.out.println("\nКнига --- возраст книги:");
        namesAndAges(books).forEach(System.out::println);
        System.out.println("\nСписок всех авторов, писавших в соавторстве с кем-либо:");
        coauthors(books).forEach(System.out::println);
        System.out.println("\nАвтор --- книги автора:");
        booksByAuthors(authors, books).entrySet().forEach(System.out::println);
    }
